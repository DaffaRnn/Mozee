<x-layout>
           ...
           <form>
            ...
            @endif
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                 ...
                 <div class="mx-auto max-w-screen-sm text-sm text-left text-gray-500 newsletter-form-footer dark:text-gray-300">Find What You Want to Learn.</div>
            </form>
        </div>
    </div>
    ...
    <div class="py-4 my-4 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-0">
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 h-full flex flex-col justify-between">
                <div>
                ...
                <!-- Bagian bawah, selalu nempel bawah card -->
            ...
            @empty
                ...
                <div class="text-center">
                    <p class="text-gray-500 font-semibold mb-4">No posts found.</p>
